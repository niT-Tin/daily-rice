...
clipboardy = spawn "rofi -modi \"\63053 :greenclip print\" -show \"\63053 \" -run-command '{cmd}' -theme ~/.config/rofi/launchers/type-7/style-1.rasi"
...
rofi_launcher = spawn "~/.config/rofi/launchers/type-7/launcher.sh"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Alt + ,
    , ((modm,  xK_comma                   ), spawn "pamixer --decrease 5")
    -- Alr + .
    , ((modm,  xK_period                  ), spawn "pamixer --increase 5")
    ...
    --
    -- mod-{w,e,r}, 切换屏幕，mod+w是最左边屏幕，mod+e是中间屏幕，mod+r是最右边屏幕
...
myStartupHook = do
  spawnOnce "~/scripts/update_date.sh"
  spawnOnce "exec ~/bin/bartoggle"
  spawnOnce "exec ~/bin/eww daemon"
  spawn "xsetroot -cursor_name left_ptr"
  -- spawn "exec ~/bin/lock.sh"
  spawnOnce "feh --bg-scale ~/wallpapers/background.jpg"
  spawnOnce "greenclip daemon"
  spawnOnce "dunst"
  spawnOnce "exec /usr/bin/fcitx5"
  spawnOnce "~/.xmonad/bing_wallpaper.sh"
  spawnOnce "~/.screenlayout/normalLayout.sh"
  -- spawnOnce "sleep 20; compton"
  -- spawnOnce "sleep 20; picom --experimental-backends"
  -- spawnOnce "/usr/bin/xmobar ~/.config/xmobar/xmobarrc"
  -- spawnOnce "~/.screenlayout/codeLayout.sh"
...
main :: IO()
main = do
  barpipe <- spawnPipe "/usr/bin/xmobar /home/liuzehao/.config/xmobar/xmobarrc"
