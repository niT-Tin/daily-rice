...
alias b=bat
alias v=vim
alias n8=/usr/local/bin/nvim.0.8
...
export JAVA_HOME=/home/liuzehao/applications/languages/jdk-11.0.15.1
...
if [ "$color_prompt" = yes ]; then
    ...
    if [ -f /etc/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]; then
        . /etc/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
...
GUIX_PROFILE="/home/liuzehao/.guix-profile"
